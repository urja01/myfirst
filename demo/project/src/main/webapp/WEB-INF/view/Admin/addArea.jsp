...
<html>
 ...
 -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Add  Area</h4><br/>
                                   
                                    <f:form  modelAttribute="aera" action="insertArea" method="post">
                                    
                                    	<div class="form-group">
                                            <label for="userName">Area<span class="text-danger"> *</span></label>
                                            <f:input path="areaName" parsley-trigger="change"
                                                   placeholder="Enter Area" class="form-control" id="addArea"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <f:textarea  path="areaDesc" class="form-control" placeholder="Enter Area"></f:textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div>
