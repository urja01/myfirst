                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Add  Route</h4><br/>
                                    
                                    <form class="" action="#">
                                    
                                    <div class="form-group">
                                            <label for="userName">Starting Route<span class="text-danger"> *</span></label>
                                            <input type="text"  parsley-trigger="change" required
                                                   placeholder="Enter Route" class="form-control" id="StartingRoute">
                                        </div>
                                     ...
                                     <div class="form-group-custom">
                                    	...
                                    	<div class="form-group">
                                            <label for="userName">Ending Route<span class="text-danger">*</span></label>
                                            <input type="text"  parsley-trigger="change" required
                                                   placeholder="Enter Route" class="form-control" id="StartingRoute">
                                        </div>
